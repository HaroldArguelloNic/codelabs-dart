...
-
    ...
    Escriba una función addHello()que toma un solo Stringargumento.
    addHello()devuelve su Stringargumento precedido de 'Hello '.
    Ejemplo: addHello('Jon')devuelve 'Hello Jon'.

Parte 2: greetUser()
-

    Escriba una función greetUser()eso no requiere argumentos.
    Para obtener el nombre de usuario, greetUser()llama a la función asincrónica proporcionada fetchUsername().
    greetUser()crea un saludo para el usuario llamando addHello(), pasándolo el nombre de usuario, y devolviendo el resultado.
    Ejemplo: Si fetchUsername()devuelve 'Jenny', entonces greetUser()devuelve 'Hello Jenny'.

Parte 3: sayGoodbye()
-

    Escriba una funciónsayGoodbye()que haga lo siguiente:
        No hace falta argumentos.
        Ataque cualquier error.
        Llamadas la función asincrónica logoutUser().
    Si logoutUser()falle, sayGoodbye()devuelve cualquier cuerda que te guste.
    Si logoutUser()éxito, sayGoodbye()devuelve la cuerda '<result> Thanks, see you next time', dónde <result>es el valor de cuerda devuelto llamando logoutUser().
