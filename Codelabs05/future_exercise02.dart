/* Uso asyncy awaitpara implementar un asincrónico changeUsername()función que haga lo siguiente:

    Llamadas la función asincrónicafetchNewUsername()y devuelve su resultado.
        Ejemplo de valor de retorno de changeUsername(): "jane_smith_92"
    Atrae cualquier error que se produzca y devuelve el valor de cadena del error.
        Puede utilizar el método toString() para encadenar tanto excepciones como Errores.
        */

//  Implement changeUsername here.
changeUsername() async{
  try {
    final newUser = await fetchNewUsername();
    return '$newUser' ;
  } catch (err) {
    return err.toString(); //retorno del error usando conversion explicita en String
  }
