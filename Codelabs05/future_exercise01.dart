...
Añadir código a la reportUserRole()función para que haga lo siguiente:

    Devuelve un futuro que se completa con la siguiente cadena:"User role: <user role>"
        Nota: Debes usar el valor real devuelto por fetchRole(); copiar y pegar el valor de retorno del ejemplo no hará que el pase de prueba.
        Ejemplo de valor de retorno: "User role: tester"
    Obsta el rol de usuario llamando a la función proporcionada fetchRole().

Parte 2: reportLogins()
-

Implementar un async función reportLogins()para que haga lo siguiente:

    Devuelve la cuerda"Total number of logins: <# of logins>".
        Nota: Debes usar el valor real devuelto por fetchLoginAmount(); copiar y pegar el valor de retorno del ejemplo no hará que el pase de prueba.
        Ejemplo de valor de retorno de reportLogins(): "Total number of logins: 57"
    Obsta el número de logins llamando a la función proporcionada fetchLoginAmount(). */

    // Part 1
// Call the provided async function fetchRole()
// to return the user role.
Future<String> reportUserRole() async {
  // Implement the reportUserRole function here.
  final userLogin = await fetchRole();
  return 'User role: $userLogin';
}
